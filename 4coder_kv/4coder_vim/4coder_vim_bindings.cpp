...
function b32 VimBind(u32 mode, Custom_Command_Function *custom, Vim_Sub_Mode sub_mode, u64 key){
	return vim_map_set_binding(mode, sub_mode, (void *)custom, key);
}
function b32 VimBind(u32 mode, Custom_Command_Function *custom, u64 key){
